...
class ProfanityFilter:
    def __init__(self):
        ...
        self.default_wordlist_filename = get_complete_path('profanity_filter/data/profanity_wordlist.txt')
        self.default_urls_filename = get_complete_path('profanity_filter/data/profane_sites.txt')
